...
//            logger.info(String.format("can not found datasource by key: '%s'----->'%s',this session may use default datasource", key,key));
//        }
//        logger.info(String.format("this session may use datasource: '%s'----->'%s'", key,key));
//        return key;
//    }
//
//    /**
...
//        String value() default "ds"; //该值即key值
//    }
//
//    /**
//     * 声明切面
...
//         */
//        @Pointcut("@within(com.wanma.demoes.ds.DynamicDataSource.DataSource)")
