...
public abstract class SearchQueryEngine<T> {
     ...
     protected Document getDocument(T t) {
         ...
         if (annotation == null) {
             return null;//throw new SearchQueryBuildException("Can't find annotation @Document on " + t.getClass().getName());
         }
         return annotation;
     }
     ...
     protected void setFieldValue(Field field, Object obj, Object value) {
         ...
         try {
             ...
             e.getMessage();//throw new SearchQueryBuildException(e);
         } finally {
     ...
     protected Object getFieldValue(Field field, Object obj) {
         ...
         try {
             ...
             return e.getMessage();//throw new SearchQueryBuildException(e);
         } finally {
             field.setAccessible(isAccessible);
         }
     }
